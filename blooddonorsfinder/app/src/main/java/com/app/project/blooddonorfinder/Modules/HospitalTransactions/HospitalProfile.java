...
import com.app.project.blooddonorfinder.Adapters.HospitalProfileAdapter;
...
public class HospitalProfile extends AppCompatActivity implements
    ...
    CharSequence titles[] = {"Donors In List", "Donors In Map", "Sent Request","Accepted Request"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HospitalProfileAdapter hospitalProfileAdapter=new HospitalProfileAdapter(getSupportFragmentManager(),titles,titles.length);
        mViewPager.setAdapter(hospitalProfileAdapter);
        ...
        new GCMHelper(HospitalProfile.this).checkAndRegister();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_hospital_profile, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        switch (item.getItemId())
        {
            ...
            case R.id.action_logout:
                ...
                Intent loginPage=new Intent(HospitalProfile.this, LoginActivity.class);
